...
const Navigation = (props: NavigationProps) => {
  ...
  return (
    <>
      <Menu as="nav" className="navbar relative w-full min-w-80 max-w-7xl ">
        <div className="flex">
        ...
        <Transition
          className=" bg-opacity-700 bg-base-700 [transform:translate3d(0,0,0)]md:hidden navbar sticky  right-0 top-24 z-30  flex h-16 w-full justify-center rounded-2xl text-base-content shadow-xl backdrop-blur transition-shadow duration-100"
